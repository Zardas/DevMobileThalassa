...
export class AccueilComptagePage extends PageSearchProvider {
  ...
  public menuContextuelOpen: boolean;
    ...
    this.calculListeNbScanTotaux();
      ...
      ['HomePage', 'InventaireComptagePage', 'NouveauComptagePage', 'ParametresGlobauxPage', 'ListeArticlePage', 'ListeMagasinPage'],
      [HomePage, InventaireComptagePage, NouveauComptagePage, ParametresGlobauxPage, ListeArticlePage, ListeMagasinPage]
    );
  ...
  //Un goTo spécial pour aller à un comptage en particulier car il faut aussi fournir l'id du comptage
